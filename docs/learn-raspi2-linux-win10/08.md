...
在目录细节之后是`ScriptAlias`，它控制应用程序如何访问 CGI 脚本。`ScriptAlias`是一个特殊的目录，这些 CGI 程序在其中运行和执行。由于 PHP 是一个很像 BASH 的脚本系统(在第七章的中讨论过)，你可能认为这有直接的关系，但事实并非如此。PHP 由一个特殊的解释模块(`modphp`)运行，而不是由一个单独的 CGI 程序运行。
...
一旦您删除了`index.html`并添加了`index.php`，将您的浏览器指向您的 Apache 服务器。图 8-2 将是你的奖励。
...
![A978-1-4842-1162-5_8_Fig6_HTML.jpg](img/A978-1-4842-1162-5_8_Fig6_HTML.jpg)
...
![A978-1-4842-1162-5_8_Fig7_HTML.jpg](img/A978-1-4842-1162-5_8_Fig7_HTML.jpg)
